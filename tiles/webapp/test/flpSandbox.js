		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bhatia Alloys Tiles",
									"targetURL": "#combhatiatiles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combhatiatiles-display": {
								"semanticObject": "combhatiatiles",
								"action": "display",
								"description": "Bhatia Alloys Tiles",
								"title": "Bhatia Alloys Tiles",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bhatia.tiles",
									"url": sap.ui.require.toUrl("com/bhatia/tiles")
								}
							}
						}
					}
